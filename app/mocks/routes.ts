...
export const ROUTES: Lane[] = [
  // ── Warehouse → DC transfer corridors ───────────────────────────────
  { id: 'LANE-LGB-LAX', name: 'West Coast Hub → Los Angeles DC', leg: 'transfer', originId: 'WH-LGB', destId: 'DC-LAX', origin: 'Long Beach, CA', destination: 'Los Angeles, CA', distanceKm: 40, avgHours: 1, status: 'active', stops: 1, driver: 'Marcus Bell', vehicle: 'TRK-118' },
  { id: 'LANE-LGB-SFO', name: 'West Coast Hub → Bay Area DC', leg: 'transfer', originId: 'WH-LGB', destId: 'DC-SFO', origin: 'Long Beach, CA', destination: 'San Francisco, CA', distanceKm: 615, avgHours: 7, status: 'active', stops: 2, driver: 'Leah Park', vehicle: 'TRK-301' },
  { id: 'LANE-LGB-SEA', name: 'West Coast Hub → Seattle DC', leg: 'transfer', originId: 'WH-LGB', destId: 'DC-SEA', origin: 'Long Beach, CA', destination: 'Seattle, WA', distanceKm: 1830, avgHours: 19, status: 'active', stops: 3, driver: 'Owen Fischer', vehicle: 'TRK-301' },
  { id: 'LANE-LGB-PHX', name: 'West Coast Hub → Phoenix DC', leg: 'transfer', originId: 'WH-LGB', destId: 'DC-PHX', origin: 'Long Beach, CA', destination: 'Phoenix, AZ', distanceKm: 600, avgHours: 6, status: 'active', stops: 2, driver: 'Marcus Bell', vehicle: 'TRK-118' },
  ...
  { id: 'LANE-EWR-BOS', name: 'East Coast Hub → Boston DC', leg: 'transfer', originId: 'WH-EWR', destId: 'DC-BOS', origin: 'Newark, NJ', destination: 'Boston, MA', distanceKm: 350, avgHours: 4, status: 'active', stops: 2, driver: 'Devin Walsh', vehicle: 'VAN-102' },
  ...
  { id: 'LANE-SAV-ATL', name: 'Southeast Hub → Atlanta DC', leg: 'transfer', originId: 'WH-SAV', destId: 'DC-ATL', origin: 'Savannah, GA', destination: 'Atlanta, GA', distanceKm: 400, avgHours: 4, status: 'active', stops: 2, driver: 'Hannah Cole', vehicle: 'TRK-230' },
  { id: 'LANE-SAV-MIA', name: 'Southeast Hub → Miami DC', leg: 'transfer', originId: 'WH-SAV', destId: 'DC-MIA', origin: 'Savannah, GA', destination: 'Miami, FL', distanceKm: 800, avgHours: 8, status: 'disrupted', stops: 3, driver: 'Hannah Cole', vehicle: 'TRK-230' },
  ...
  { id: 'LANE-SEA-METRO', name: 'Seattle DC → metro', leg: 'last-mile', originId: 'DC-SEA', destId: 'DC-SEA', origin: 'Seattle DC', destination: 'Greater Seattle', distanceKm: 50, avgHours: 1, status: 'disrupted', stops: 5, driver: 'Owen Fischer', vehicle: 'TRK-301' },
  { id: 'LANE-PHX-METRO', name: 'Phoenix DC → metro', leg: 'last-mile', originId: 'DC-PHX', destId: 'DC-PHX', origin: 'Phoenix DC', destination: 'Greater Phoenix', distanceKm: 55, avgHours: 1, status: 'active', stops: 4, driver: 'Noah Brennan', vehicle: 'VAN-150' },
  { id: 'LANE-JFK-METRO', name: 'New York DC → metro', leg: 'last-mile', originId: 'DC-JFK', destId: 'DC-JFK', origin: 'New York DC', destination: 'NYC metro', distanceKm: 60, avgHours: 2, status: 'active', stops: 8, driver: 'Isabela Cruz', vehicle: 'VAN-105' },
  ...
  { id: 'LANE-DFW-METRO', name: 'Dallas DC → metro', leg: 'last-mile', originId: 'DC-DFW', destId: 'DC-DFW', origin: 'Dallas DC', destination: 'DFW metroplex', distanceKm: 65, avgHours: 2, status: 'active', stops: 5, driver: 'Carlos Mendez', vehicle: 'TRK-211' },
  { id: 'LANE-ORD-METRO', name: 'Chicago DC → metro', leg: 'last-mile', originId: 'DC-ORD', destId: 'DC-ORD', origin: 'Chicago DC', destination: 'Chicagoland', distanceKm: 55, avgHours: 2, status: 'active', stops: 6, driver: 'Tasha Okafor', vehicle: 'VAN-140' },
]
