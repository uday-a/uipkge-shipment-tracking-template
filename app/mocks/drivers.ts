...
export const DRIVERS: Driver[] = [
  ...
  { id: 'DRV-09', name: 'Greta Lindqvist', initials: 'GL', status: 'available', phone: '+1 816-555-0109', homeBase: 'Kansas City, MO', vehicle: 'TRK-220', license: 'CDL-A', rating: 4.7, deliveriesToday: 3, onTimeRate: 93, yearsActive: 10 },
